...
export const processTreeData = (
    ...
    fields: {selectField: string; expandField: string; dataItemKey: any; subItemsField: string}
) => {
...
export const expandedState = (item: any, dataItemKey: number, expanded: Array<number>) => {
