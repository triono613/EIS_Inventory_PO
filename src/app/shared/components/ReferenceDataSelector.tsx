...
export function ReferenceDataSelector(props: ReferenceDataSelectorProps) {
    ...
    const loadData = () => {
        ...
        axios
            .get(props.dataUrl)
            .then((response) => {
                console.log('ReferenceDataSelector.loadData() response: ', response)
                setSourceData(response.data)
                setData(response.data)
                //console.log('ReferenceDataSelector.props.value = ', props.value)
                // if (props.value) {
    ...
    const handleChange = (event: ComboBoxChangeEvent) => {
        if (event) {
            ...
            console.log('ReferenceDataSelector.handleChange(); value = ', value)
            //setValue(value)
    ...
    const itemFromValue = (value: any) => {
        return value !== null && value !== undefined ?
            sourceData.find((item:any) => item['id'] === value) : value
    }

    console.log('ReferenceDataSelector redraw(); props.value = ', props.value)
...
interface FormReferenceDataSelectorProps {
...
export const FormReferenceDataSelector = (props: FormReferenceDataSelectorProps) => {
