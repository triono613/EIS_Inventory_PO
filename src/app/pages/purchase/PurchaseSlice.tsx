...
export const loadData = createAsyncThunk<Product, string>(
...
export const { gridStateChanged, gridPageChanged, userGridLoaded, dataLoading, dataLoaded, newData } = PurchaseSlice.actions
